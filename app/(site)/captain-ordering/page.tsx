      ...
      <section className="border-b border-border bg-muted/25 px-4 pb-16 pt-28 sm:px-6 sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground text-pretty">
            Table map and floor service tools so captains run the room with confidence.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="prose prose-lg mx-auto">
            <p>
              Table Management, Inventory Management, and Reporting with the mobile application.
            </p>
